...
<body>
      ...
      <main class="main">
        ...
        <div class="tabs">
          ...
          <div class="purple" onclick="window.location.href='#podcast'">
            <h1 id="titulo-genero">Me Gusta</h1>
          </div>
        </div>
        <br>
        <div class="content">
          ...
          <div class="player">
            <div class="album-cover">
              <img id="album-image" src="{{ asset('image/images/El-piano.jpg') }}" alt="genre" />
    ...
    <script src="{{ asset('js/musicoterapia.js/ME GUSTA/scrip.js') }}"></script>
</body>
</html>