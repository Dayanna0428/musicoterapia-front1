...
<head>
 ...
 <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/REPRODUCCTORES/REPRO_PODCAST/AUTOESTIMA/style.css') }}">
...
<body>
  ...
  <div class="container">
          ...
          <div class="video-scroll-wrapper" id="videoScrollWrapper">
              <div class="video-card">
                  <video class="video-player" loop controls>
                      <source src="/musicoterapia/Vistas1.1/Videos/AUTOESTIMA-VID/WhatsApp Video 2025-02-17 at 10.59.17 PM.mp4" type="video/mp4">
              ...
              <div class="video-card">
                  <video class="video-player" loop controls>
                      <source src="/musicoterapia/Vistas1.1/Videos/AUTOESTIMA-VID/WhatsApp Video 2025-02-17 at 10.59.20 PM.mp4" type="video/mp4">
                      Your browser does not support the video tag.
                  </video>
                  <div class="video-actions">
                      <button class="action-button like-button">
              ...
              <div class="video-card">
                <video class="video-player" loop controls>
                    <source src="/musicoterapia/Vistas1.1/Videos/AUTOESTIMA-VID/WhatsApp Video 2025-02-17 at 10.59.23 PM.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                <div class="video-actions">
                    <button class="action-button like-button">
    ...
    <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/REPRO_PODCAST/AUTOESTIMA/scrip.js') }}"></script>
<body>
</html>