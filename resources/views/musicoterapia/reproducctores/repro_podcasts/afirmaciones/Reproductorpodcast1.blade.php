...
<head>
 ...
 <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/REPRODUCCTORES/REPRO_PODCAST/AFIRMACIONES/style.css') }}">
...
<body>
        ...
        <div class="video-scroll-wrapper" id="videoScrollWrapper">
          <div class="video-card">
            <video class="video-player" loop controls>
              <source
                src="/musicoterapia/Vistas1.1/Videos/AFIRMACIONES-VID/WhatsApp Video 2025-02-17 at 11.08.16 PM.mp4"
                type="video/mp4">
          ...
          <div class="video-card">
            <video class="video-player" loop controls>
              <source
                src="/musicoterapia/Vistas1.1/Videos/AFIRMACIONES-VID/WhatsApp Video 2025-02-17 at 11.08.20 PM.mp4"
                type="video/mp4">
              Your browser does not support the video tag.
            </video>
            <div class="video-actions">
          ...
          <div class="video-card">
            <video class="video-player" loop controls>
              <source
                src="/musicoterapia/Vistas1.1/Videos/AFIRMACIONES-VID/WhatsApp Video 2025-02-17 at 11.08.25 PM.mp4"
                type="video/mp4">
              Your browser does not support the video tag.
            </video>
            <div class="video-actions">
  ...
  <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/REPRO_PODCAST/AFIRMACIONES/script.js') }}"></script>
