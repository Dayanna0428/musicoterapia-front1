...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/Header/style copy.css') }}">
    <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/REPRODUCCTORES/GENERO_ELEGIDO/AMBIENTAL/styles.css') }}">
    <style>
      body {
    background-image: 
...
<body>
    ...
    <main class="main">
      ...
      <div class="tabs">
        ...
        <div class="purple" onclick="window.location.href='#podcast'">
          <h1 id="titulo-genero">Género Ambiental</h1>
        </div>
      </div>
      <br>
      <div class="content">
        <div class="player">
          <div class="album-cover">
            <img id="album-image" src="/musicoterapia/Vistas1.1/images/AMBIENTAL 1.jpg" alt="genre" />
          ...
          <div class="actions">
            ...
            <div id="create-playlist-form" class="playlist-form" style="display: none;">
              ...
              <button id="create-playlist-btn">Aceptar</button>
            </div>
          </div>
  ...
  @include('musicoterapia.Fotter.inicio.footer')
    ...
    <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/GENERO_ELEGIDO/AMBIENTAL/script.js') }}"></script>
</body>
