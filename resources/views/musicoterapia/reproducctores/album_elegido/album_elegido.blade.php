  ...
  @include('musicoterapia.Header.header')
    <div class="container">
      ...
      <main class="main">
        ...
        <audio id="audio" src="/musicoterapia/Vistas1.1/audio/genero-audio/AMBIENTAL/inspiring-cinematic-ambient-116199.mp3"></audio>
        <audio id="audio" src="/musicoterapia/Vistas1.1/audio/genero-audio/AMBIENTAL/perfect-beauty-191271.mp3"></audio>
        <audio id="audio" src="/musicoterapia/Vistas1.1/audio/genero-audio/AMBIENTAL/calm-background-music-ambient-guitar-298550.mp3"></audio>
    </main>
    </div>
    <br>
    <br>
    ...
    <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/ALBUM_ELEGIDO/scrip.js') }}"></script>
</body>
</html>