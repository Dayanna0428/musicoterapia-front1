...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/REPRODUCCTORES/ALBUM_ELEGIDO/GAMER/style.css') }}">
  <style>
    body {
  background-image: 
...
<body>
    ...
    <main class="main">
      ...
      <div class="tabs">
        ...
        <div class="purple" onclick="window.location.href='#podcast'">
          <h1 id="titulo-album">Álbum Gamer</h1>
        </div>
      </div>
      <br>
      <div class="content">
  ...
  <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/ALBUM_ELEGIDO/GAMER/script.js') }}"></script>
</body>
