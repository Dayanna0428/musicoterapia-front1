...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/Header/style copy.css') }}">
    <link rel="stylesheet" href="{{ asset('css/musicoterapia.css/REPRODUCCTORES/REPRO_PISTAS/style.css') }}">
    <style>
      body {
    background-image: 
  ...
  <title>Tranquilidad - Reproductor</title>
  <script>
    ...
    <main class="main">
      ...
      <div class="tabs">
        ...
        <div class="purple" onclick="window.location.href='#podcast'">
          <span id="playlist-name">Lista de Reproducción<span>
        </div>
      </div>
      <br>
      <div class="content">
          ...
          <div class="actions">
            ...
            <div id="dropdown" class="dropdown">
              ...
              <div id="playlist-dropdown" class="nested-dropdown">
                ...
                <div class="dropdown-content" onclick="createNewPlaylist()"><i>+ Crear nueva playlist</i></div>
              </div>
      ...
      <audio id="audio-player"></audio> <!-- Single audio element -->
    </main>
  </div>
  <br><br><br><br>
  @include('musicoterapia.Fotter.inicio.footer')
    
  <script src="{{ asset('js/musicoterapia.js/REPRODUCCTORES/REPRO_PISTAS/script.js') }}"></script>
  <script>
